<template>
  <ul class="task-list">
    <li class="task-list__item" v-for="task in tasks" :key="task.id" :class="{ 'task-finished': task.completed }">
      ...
      <div class="item__buttons">
        <button @click="finishTask(task.id)"><img src="../assets/tick.svg"></button>
...
export default {
  ...
  setup(props) {
    ...
    const finishTask = (taskId) => {
      store.commit('toggleFinishing', taskId);
    };
